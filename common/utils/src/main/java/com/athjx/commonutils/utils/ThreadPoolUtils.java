...
public final class ThreadPoolUtils {
    ...
    public static void main(String[] args) {
        ThreadPoolUtils tpu = new ThreadPoolUtils(0, 10);
        tpu.execute(() -> System.out.println(" I DO"));
    }
     ...
     */
    public ScheduledFuture scheduleWithFixedRate(final Runnable command, final long initialDelay, final long period,
            final TimeUnit unit) {
